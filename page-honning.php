	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="subMenu">
				...
				<ul class="grid-2">
					<li><a href="/wordpress/honning/" class="active">Honning</a></li>
					<li><a href="/wordpress/honning-handtering/">Håndtering</a></li>
				</ul>
            </div>
			...
			<h2>Honning</h2>
				<ul>
					<?php $honning = new WP_query('category_name=honning'); ?>
					<?php while ($honning->have_posts() ) : $honning->the_post(); ?>
