	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="subMenu">
				...
				<ul class="grid-5">
					<li><a href="/wordpress/frugt-gront-vinter/">Vinter</a></li>
					<li><a href="/wordpress/frugt-gront-forar/">Forår</a></li>
					<li><a href="/wordpress/frugt-gront-efterar/" class="active">Efterår</a></li>
					<li><a href="/wordpress/frugt-gront-sommer/">Sommer</a></li>
					<li><a href="/wordpress/frugt-gront-handtering/">Håndtering</a></li>
				</ul>
            </div>
			...
			<h2>Efterår</h2>
				...
				<ul>
					<?php $efteraar= new WP_query('category_name=efterar'); ?>
					<?php while ($efteraar->have_posts() ) : $efteraar->the_post(); ?>
