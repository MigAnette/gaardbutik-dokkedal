	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="page-banner">
                ...
                <h1>Om <?php the_title();?></h1><!--Here the only thing that needs to be dynamic is the products overall name fx kød-->
		...
		<div id="vueApp">
			...
			<div class="subMenu">
				...
				<ul class="grid-4">
                    <li><a href="/wordpress/garden/" class="active">Historien</a></li>
                    <li><a href="/wordpress/garden-far/">Fårene</a></li>
                    <li><a href="/wordpress/garden-grise/">Grisene</a></li>
                    <li><a href="/wordpress/garden-hons/">Hønsene</a></li>
