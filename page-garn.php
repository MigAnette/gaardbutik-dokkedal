	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="subMenu">
				...
				<ul class="grid-2">
					<li><a href="/wordpress/garn/" class="active">Garn</a></li>
					<li><a href="/wordpress/garn-handtering/">Håndtering</a></li>
				</ul>
            </div>
			...
			<h2>Garn</h2>
				<ul>
					<?php $garn = new WP_query('category_name=garn'); ?>
					<?php while ($garn->have_posts() ) : $garn->the_post(); ?>
