	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="subMenu">
				...
				<ul class="grid-2">
					<li><a href="/wordpress/aeg/" class="active">Æg</a></li>
					<li><a href="/wordpress/aeg-handtering/">Håndtering</a></li>
				</ul>
            </div>
			...
			<h2>Æg</h2>
				<ul>
					<?php $aeg = new WP_query('category_name=aeg'); ?>
					<?php while ($aeg->have_posts() ) : $aeg->the_post(); ?>
