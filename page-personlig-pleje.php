	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="subMenu">
				...
				<ul class="grid-2">
                <li><a href="/wordpress/personlig-pleje/" class="active">Personlig Pleje</a></li>
					<li><a href="/wordpress/personlig-pleje-handtering/">Håndtering</a></li>
				</ul>
            </div>
			...
			<h2>Personlig Pleje</h2>
				<ul>
					<?php $personlig = new WP_query('category_name=personlig'); ?>
					<?php while ($personlig->have_posts() ) : $personlig->the_post(); ?>
