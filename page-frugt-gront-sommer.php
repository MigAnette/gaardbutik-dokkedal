		...
		<main id="main" class="site-main">
			...
			<div class="subMenu">
				...
				<ul class="grid-5">
					...
					<li><a href="/wordpress/frugt-gront-efterar/">Efterår</a></li>
					<li><a href="/wordpress/frugt-gront-sommer/" class="active">Sommer</a></li>
			...
			<h2>Sommer</h2>
				<ul>
					<?php $sommer = new WP_query('category_name=sommer'); ?>
					<?php while ($sommer->have_posts() ) : $sommer->the_post(); ?>
