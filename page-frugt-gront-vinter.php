	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="subMenu">
				...
				<ul class="grid-5">
					<li><a href="/wordpress/frugt-gront-vinter/" class="active">Vinter</a></li>
            ...
            <section class="products">
                ...
                <h2>Vinter</h2>
                <ul>
					<?php $vinter = new WP_Query('category_name=vinter'); ?>
					<?php while ($vinter->have_posts() ) : $vinter->the_post(); ?>
