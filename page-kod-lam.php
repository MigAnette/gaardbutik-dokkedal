	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<div class="subMenu">
				...
				<ul class="grid-3">
                    <li><a href="/wordpress/kod-lam/" class="active">Lam</a></li>
                    <li><a href="/wordpress/kod-gris/">Gris</a></li>
            ...
            <section class="products">
				...
				<h2>Lam</h2>
				<ul>
					<?php $lam = new WP_query('category_name=lam'); ?>
					<?php while ($lam->have_posts() ) : $lam->the_post(); ?>

					
						<li><!--Everything in this li tag needs to be dynamic. Using categories and posts it should be possible-->
							<!--this would be the featured image to the product-->
